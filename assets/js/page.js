  ...
  switch(week){
    case 'week1' :
      switch (part){
        case 'part1' :
          title = [
            '본격적으로 배우기 앞서 우리가 익혀야 할 개념이 있습니다.', 'GUI와 CLI가 무엇인가?', 'GUI와 CLI가 무엇인가?','CLI 명령어는 어떤게 있는가?',
          ]
          return title;
        case 'part2' :
          title = [
            '프로젝트 관리', '깃과 깃허브는 무엇인가?', '이미지로 보는 깃과 깃허브',
          ]
          return title;
        case 'part3' :
          title = [
            '자주 사용하는 깃 명령어', '자주 사용하는 깃 명령어', '원격저장소에 연결을 하는 순서',
          ]
          return title;
      }
    case 'week2' :
      switch (part){
        case 'part1' :
          title = [
            '깃 플로우', 'fetch? pull?', 'vscode에서 브랜치 생성하기', '깃허브에 생성된 브랜치 가져오기', '충돌은 어떻게 해결하나요?'
          ]
          return title;
        case 'part2' :
          title = [
            'HTML과 CSS와 javascript','html의 구조', '자주 사용하는 meta 태그','css 용어 설명','변수와 함수 그리고 스코프','변수와 함수 그리고 스코프'
          ]
          return title;
        case 'part3' :
          title = [
            '모듈이란?', '요청과 응답', '라우터와 핸들러', '데이터베이스', 'SQL 작성하기'
          ]
          return title;
      } 
  }
